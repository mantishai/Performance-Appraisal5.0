...
const server = http.createServer(async (req, res) => {
    ...
    try {
        if (url === '/api/auth/login' && method === 'POST') {
        ...
        else if (url === '/api/org/departments/tree' && method === 'GET') {
            const [rows] = await pool.execute(`
                SELECT id, dept_name as name, dept_code as code, parent_id as parentId, status, phone, description
                FROM department
                ORDER BY id
        ...
        else if (url === '/api/org/employees/for-select' && method === 'GET') {
            const [rows] = await pool.execute(`
                SELECT id, name, employee_no as employeeNo, position_id as positionId,
                       department_id as departmentId, status, phone, email
                FROM employee
        ...
        else if (url === '/api/leave/list' && method === 'GET') {
            sendJSON(res, {
                code: 200,
                data: [],
                message: 'success'
        ...
        else if (url === '/api/recruitment/interviews' && method === 'GET') {
            sendJSON(res, {
                code: 200,
                data: [],
                message: 'success'
        ...
        else if (url === '/api/performance/evaluations' && method === 'GET') {
            sendJSON(res, {
                code: 200,
                data: [],
                message: 'success'
        ...
        else if (url === '/api/training/courses' && method === 'GET') {
            sendJSON(res, {
                code: 200,
                data: [],
                message: 'success'
        ...
        else if (url === '/api/training/my-courses' && method === 'GET') {
            sendJSON(res, {
                code: 200,
                data: [],
                message: 'success'
        ...
        else if (url === '/api/training/records' && method === 'GET') {
            sendJSON(res, {
                code: 200,
                data: [],
                message: 'success'
        ...
        else if (url === '/api/alert/list' && method === 'GET') {
            sendJSON(res, {
                code: 200,
                data: [],
                message: 'success'
        ...
        else if (url === '/api/alert/risk-prediction' && method === 'GET') {
            sendJSON(res, {
                code: 200,
                data: [],
                message: 'success'
        ...
        else if (url === '/api/system/dashboard' && method === 'GET') {
            sendJSON(res, {
                code: 200,
                data: {},
                message: 'success'
        ...
        else if (url === '/api/system/announcements' && method === 'GET') {
            sendJSON(res, {
                code: 200,
                data: [],
                message: 'success'
        ...
        else if (url === '/api/system/todos' && method === 'GET') {
            sendJSON(res, {
                code: 200,
                data: [],
                message: 'success'
        ...
        else if (url === '/api/system/schedule' && method === 'GET') {
            sendJSON(res, {
                code: 200,
                data: [],
                message: 'success'
        ...
        else if (url.match(/^\/api\/org\/department\/\d+\/employees/) && method === 'GET') {
            sendJSON(res, {
                code: 200,
                data: [],
                message: 'success'
        ...
        else if (url === '/api/org/department/statistics' && method === 'GET') {
            sendJSON(res, {
                code: 200,
                data: {},
                message: 'success'
            ...
            sendJSON(res, { code: 200, data: [], message: 'success' });
        }
    } catch (error) {
...
server.listen(8080, () => {
    console.log('Full API Server started on http://localhost:8080');
    console.log('All endpoints are active');
});
