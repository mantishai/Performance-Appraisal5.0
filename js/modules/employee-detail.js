...
const employeeDetailModule = {
    async open(employee) {
        ...
        setTimeout(() => {
            ...
            console.log('Final drawer element:', drawer);
            console.log('Final drawer style:', drawer?.style);
            console.log('Final drawer computed display:', drawer ? window.getComputedStyle(drawer).display : 'null');
            console.log('Final drawer computed z-index:', drawer ? window.getComputedStyle(drawer).zIndex : 'null');
            console.log('Final drawer computed opacity:', drawer ? window.getComputedStyle(drawer).opacity : 'null');
