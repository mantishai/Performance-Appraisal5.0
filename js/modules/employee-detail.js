...
const employeeDetailModule = {
    ...
    async saveDetail() {
        const data = {
            ...
            workYears: document.getElementById('modalWorkYears').value ? parseInt(document.getElementById('modalWorkYears').value) : null,
            ...
            salary: document.getElementById('modalSalary').value ? parseFloat(document.getElementById('modalSalary').value) : null,
            annualSalary: document.getElementById('modalAnnualSalary').value ? parseFloat(document.getElementById('modalAnnualSalary').value) : null,
            socialSecurityBase: document.getElementById('modalSocialSecurityBase').value ? parseFloat(document.getElementById('modalSocialSecurityBase').value) : null,
